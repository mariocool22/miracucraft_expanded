...
import net.mcreator.miracucraftexpanded.procedures.LadybeesuittickProcedure;
import net.mcreator.miracucraftexpanded.MiracucraftExpandedModElements;
...
public class LadybeeItem extends MiracucraftExpandedModElements.ModElement {
	@ObjectHolder("miracucraft_expanded:ladybee_helmet")
	public static final Item helmet = null;
	@ObjectHolder("miracucraft_expanded:ladybee_chestplate")
	public static final Item body = null;
	@ObjectHolder("miracucraft_expanded:ladybee_leggings")
	public static final Item legs = null;
	@ObjectHolder("miracucraft_expanded:ladybee_boots")
	public static final Item boots = null;

	public LadybeeItem(MiracucraftExpandedModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new ModelLadybee().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "miracucraft_expanded:textures/models/armor/ladybee__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				LadybeesuittickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("ladybee_helmet"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedBody = new ModelLadybee().Body;
				armorModel.bipedLeftArm = new ModelLadybee().LeftArm;
				armorModel.bipedRightArm = new ModelLadybee().RightArm;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("ladybee_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedLeftLeg = new ModelLadybee().LeftLeg;
				armorModel.bipedRightLeg = new ModelLadybee().RightLeg;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("ladybee_leggings"));
