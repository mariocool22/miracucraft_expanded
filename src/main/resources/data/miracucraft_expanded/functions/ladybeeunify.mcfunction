...
execute as @e[tag=LadybeeTransforming] run replaceitem entity @s armor.head miraculous_fanmade_suits:lady_bee_helmet{Enchantments:[{id:binding_curse,lvl:1},{id:"minecraft:unbreaking",lvl:3s},{id:"minecraft:vanishing_curse",lvl:1s}],Unbreakable:1}
execute as @e[tag=LadybeeTransforming] run replaceitem entity @s armor.chest miraculous_fanmade_suits:lady_bee_chestplate{Enchantments:[{id:binding_curse,lvl:1},{id:"minecraft:unbreaking",lvl:3s},{id:"minecraft:vanishing_curse",lvl:1s}],Unbreakable:1}
execute as @e[tag=LadybeeTransforming] run replaceitem entity @s armor.legs minecraft:air
execute as @e[tag=LadybeeTransforming] run replaceitem entity @s armor.feet miraculous_fanmade_suits:lady_bee_boots{Enchantments:[{id:binding_curse,lvl:1},{id:"minecraft:unbreaking",lvl:3s},{id:"minecraft:vanishing_curse",lvl:1s}],Unbreakable:1}
...
execute as @e[tag=LadybeeTransforming] run execute at @s run effect give @s alucardmiracucraft:creation_power 999999
execute as @e[tag=LadybeeTransforming] run execute at @s run effect give @s alucardmiracucraft:power_action 999999
